      ...
      <div id="print_component">
        ...
        <div style={{ display: "none" }}>
          <ComponentToPrint
            ...
            diamondTypeList={props.diamondTypeList}
            EmployeeName={props.EmployeeName}
            totalPcs={props.totalPcs}
            price={props.price}
            totalSalary={props.totalSalary}
            patlaPcs={props.patlaPcs}
            extraJadaPcs={props.extraJadaPcs}
            zadaPcs={props.zadaPcs}
            print={true}
            from={props.from}
            to={props.to}
          />
          ...
          <table style={{ margin: "50px" }}>
            ...
            {diamondTypeList.map((ele) => {
              return (
                <Tr>
                  <Td>{ele} Pcs. </Td>
                  <Td>{totalPcs[`${ele}pcs`] || 0}</Td>
                  <Td> {price[`${ele}Price`] || 0}</Td>
                </Tr>
              );
            })}
            <Tr>
